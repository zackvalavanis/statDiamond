...
class User(Base): 
  ...
  hashed_password = Column(String, unique=true, nullable=False) # we never store plane passwords itll be hashed
  name = Column(String, unique=True, nullable=False) #Nullable=false means that it is required
